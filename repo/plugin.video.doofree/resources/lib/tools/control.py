...
def metaFile():
    if condVisibility('System.HasAddon(script.doofree.metadata)'):
        return os.path.join(xbmcaddon.Addon('script.doofree.metadata').getAddonInfo('path'), 'resources', 'data', 'meta.db')
